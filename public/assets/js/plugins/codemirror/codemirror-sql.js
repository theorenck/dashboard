...
(function() {
  ...
  var sqlKeywords = "limit offset all alter and as asc between by count create delete desc distinct drop from having in insert into is join like not on or order select set table union update values where ";
  ...
  CodeMirror.defineMIME("text/x-sql", {
    name: "sql",
    keywords: set(sqlKeywords + "group begin avg min max sum truncate round convert count timestampadd mod cdate ctime ctimestamp"),
