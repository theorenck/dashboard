...
Atlas.controller('dashboardFakeDetailController', [
  ...
  function($scope, $routeParams, Dashboards, SourceService, QueryService, AggregationService){
    data = {"id":1, "name":"Painel de Mecânica", "description":"Painel de Mecânica", "data_source_servers":[{"id":1, "url":"http://localhost:3000/api", "name":"localhost", "description":"localhost", "alive":true } ], "widgets":[{"id":1, "customized":false, "name":"Rent. Peças", "description":"Rent. Peças", "color":"blue", "position":0, "size":3, "dashboard_id":1, "indicator":{"id":1, "name":"Rent. Peças", "description":"rent_pecas", "code":"rent_pecas", "unity_id":1, "source_id":3, "unity":{"id":1, "name":"Moeda", "symbol":"%"} }, "widget_type":{"id":2, "name":"status"} }, {"id":2, "customized":false, "name":"Rent. MO", "description":"Rent. MO", "color":"red", "position":1, "size":3, "dashboard_id":1, "indicator":{"id":2, "name":"Rent. MO", "description":"rent_mo", "code":"rent_mo", "unity_id":1, "source_id":3, "unity":{"id":1, "name":"Moeda", "symbol":"%"} }, "widget_type":{"id":2, "name":"status"} }, {"id":3, "customized":false, "name":"Rent. Terceiros", "description":"Rent. Terceiros", "color":"orange", "position":2, "size":3, "dashboard_id":1, "indicator":{"id":3, "name":"Rent. Terceiros", "description":"rent_terceiros", "code":"rent_terceiros", "unity_id":1, "source_id":3, "unity":{"id":1, "name":"Moeda", "symbol":"%"} }, "widget_type":{"id":2, "name":"status"} }, {"id":4, "customized":false, "name":"Rent. MC", "description":"Rent. MC", "color":"green", "position":3, "size":3, "dashboard_id":1, "indicator":{"id":4, "name":"Rent. MC", "description":"rent_mc", "code":"rent_mc", "unity_id":1, "source_id":3, "unity":{"id":1, "name":"Moeda", "symbol":"%"} }, "widget_type":{"id":2, "name":"status"} }, {"id":6, "customized":false, "name":"Ticket Médio Peças", "description":"Ticket Médio Peças", "color":"green", "position":3, "size":3, "dashboard_id":1, "indicator":{"id":6, "name":"Ticket Médio Peças", "description":"ticket_medio_pecas", "code":"ticket_medio_pecas", "unity_id":1, "source_id":3, "unity":{"id":1, "name":"Moeda", "symbol":"R$"} }, "widget_type":{"id":2, "name":"status"} }, {"id":7, "customized":false, "name":"Ticket Médio MO", "description":"Ticket Médio MO", "color":"green", "position":3, "size":3, "dashboard_id":1, "indicator":{"id":7, "name":"Ticket Médio PO", "description":"ticket_medio_mao_de_obra", "code":"ticket_medio_mao_de_obra", "unity_id":1, "source_id":3, "unity":{"id":1, "name":"Moeda", "symbol":"R$"} }, "widget_type":{"id":2, "name":"status"} }, {"id":8, "customized":false, "name":"Inadimplência", "description":"Inadimplência", "color":"green", "position":3, "size":3, "dashboard_id":1, "indicator":{"id":8, "name":"Inadimplência", "description":"inadimplencia", "code":"inadimplencia", "unity_id":1, "source_id":3, "unity":{"id":1, "name":"Moeda", "symbol":"%"} }, "widget_type":{"id":2, "name":"status"} }, {"id":9, "customized":false, "name":"Faturamento", "description":"Faturamento", "color":"green", "position":3, "size":3, "dashboard_id":1, "indicator":{"id":9, "name":"Faturamento", "description":"faturamento", "code":"faturamento", "unity_id":1, "source_id":3, "unity":{"id":1, "name":"Moeda", "symbol":"R$"} }, "widget_type":{"id":2, "name":"status"} }, {"id":5, "customized":false, "name":"Novas OS por dia", "description":"Novas OS por dia", "color":"blue", "position":3, "size":12, "dashboard_id":1, "indicator":{"id":5, "name":"Novas OS por dia", "description":"novas_os_dia", "code":"novas_os_dia", "unity_id":1, "source_id":3, "unity":{"id":1, "name":"Moeda", "symbol":"%"} }, "widget_type":{"id":2, "name":"line"} }, ] };
    $scope.dashboard              = {};
    $scope.sourceList             = [];
    $scope.dataSourceServer       = {};
    $scope.activeDataSourceServer = {};
